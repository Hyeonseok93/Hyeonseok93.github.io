...
- **오픈소스 도구(OWASP ZAP, Semgrep)의 한계:** 가공되지 않은 영문 리포트, 나뉜 CLI 도구를 수동으로 설정하고 모으는 데 **진단 업무 시간의 40% 이상이 드는 비효율**, 수천 건씩 나오는 **과도한 오탐(False Positive)** 때문에 조치를 포기하게 만들 수 있습니다.
